defmodule UserCatsRefWeb.UserControllerTest do
  use UserCatsRefWeb.ConnCase

  import UserCatsRef.UserContextFixtures

  @create_attrs %{date_of_birth: ~D[2022-05-03], first_name: "some first_name", last_name: "some last_name"}
